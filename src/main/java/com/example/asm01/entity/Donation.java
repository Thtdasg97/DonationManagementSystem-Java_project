...
public class Donation {
    ...
    @Column(name = "status")
    private int status;
    @OneToMany(mappedBy = "donation", fetch = FetchType.LAZY, cascade =
    ...
    public Donation(String code, String created, String description, String endDate, int money, String name, String organizationName,
